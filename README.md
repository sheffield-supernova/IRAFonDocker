...
**Note** this installs the barest version of iraf (i.e. no special packages), and iraf has no been setup for the user (so, each time, one will have to go through the process of making an IRAF directory and running "mkiraf").
